...
const AccordionItem = ({obj, addToOrder, ticker}) => {
	...
	const accordionItem = obj.map((value, idx) => {
		...
		return (
			<div className="accordion-item" ref={itemRef} onMouseEnter={(e) => mouseEnter(e)} onMouseLeave={(e) => mouseLeave(e)} key={idx} >
							<div className="accordion-img">
								<img src={Object.values(value.img)[0]} alt={value.title} className='image'/>
							...
							<div className="item-info">
								...
								<div className="item-price">{value.price} ₽</div>
									<button className="accordion-btn" onClick={() => addToOrder(itemToOrder)}>
